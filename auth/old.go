...
// OldAuthSystem authenticates a request against the openslides-auth-service.
//
// Has to be initialized with auth.newOld().
type OldAuthSystem struct {
	fake bool
...
// NewOldAuthSystem initializes the old Auth object.
//
// Returns the initialized Auth objectand a function to be called in the
// background.
func NewOldAuthSystem(lookup environment.Environmenter, messageBus LogoutEventer) (*OldAuthSystem, func(context.Context, func(error)), error) {
	url := fmt.Sprintf(
		"%s://%s:%s",
...
func (a *OldAuthSystem) Authenticate(w http.ResponseWriter, r *http.Request) (context.Context, error) {
	if a.fake {
...
func (a *OldAuthSystem) AuthenticatedContext(ctx context.Context, userID int) context.Context {
...
func (a *OldAuthSystem) FromContext(ctx context.Context) int {
	if a.fake {
		return 1
	}
...
func (a *OldAuthSystem) listenOnLogouts(ctx context.Context, logoutEventer LogoutEventer, errHandler func(error)) {
	if errHandler == nil {
...
func (a *OldAuthSystem) pruneOldData(ctx context.Context) {
...
func (a *OldAuthSystem) loadToken(w http.ResponseWriter, r *http.Request, payload jwt.Claims) error {
...
func (a *OldAuthSystem) handleInvalidToken(ctx context.Context, invalid *jwt.ValidationError, w http.ResponseWriter, encodedToken, encodedCookie string) error {
...
func (a *OldAuthSystem) refreshToken(ctx context.Context, token, cookie string) (string, error) {
