...
func (m MotionStatuteParagraph) see(ctx context.Context, ds *dsfetch.Fetch, MotionStatuteParagraphIDs ...int) ([]int, error) {
	return meetingPerm(ctx, ds, m, MotionStatuteParagraphIDs, perm.MotionCanSee)
}
